...
class TestPolicyRules(unittest.TestCase):
    ...
    def test_r1_weak_signal(self):
        ...
        # In-person transaction with fraud probability 0.42
        ctx = {
            "verdict": "uncertain",
        ...
        # Online transaction with fraud probability 0.55
        ctx_online = {
            "verdict": "uncertain",
        ...
        # High probability (>= 0.70) does not match R1
        ctx_high = {
        ...
        self.assertFalse(res_high.matched)
